...
var generatePassword = function () {
  ...
  while (!passwordTotal) {
    var passwordTotal = prompt(
      "What is your password LENGTH? 8 - 128 Characters"
    );
    if (passwordTotal === "" || passwordTotal === null) {
      window.alert(
        "You need to provide a valid number. Please try again. 8 - 128 Characters"
      );
      return "I bet you didn't ask nice enough... Click Generate Password.";
    } else if (passwordTotal >= 8 && passwordTotal <= 128) {
      window.alert(
        "Your password will be " + passwordTotal + " characters long! Woohoo!"
      );
      console.log(
        "Your password has a total of: \n" + passwordTotal + " characters"
      );
    } else {
      window.alert(
        "You need to provide a valid number. Please try again. 8 - 128 Characters"
  ...
  var confirmSpecCharacters = window.confirm(
    "Would you like to have SPECIAL CHARACTERS in your password?"
  );
  if (confirmSpecCharacters === true) {
    console.log(
      "You selected to have SPECIAL CHARACTERS added to your password."
    );
  ...
  var confirmUpperCase = window.confirm(
    "How do you feel about UPPERCASE LETTERS?"
  );
  if (confirmUpperCase === true) {
    console.log(
      "You selected to have UPPERCASE CHARACTERS added to your password."
    );
  ...
  if (confirmLowerCase === true) {
    console.log(
      "You selected to have LOWERCASE LETTERS added to your password."
    );
  ...
  var confirmPassword = window.confirm(
    "Are you ready to receive your password?"
  );
